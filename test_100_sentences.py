...
使用 100 句自然語言測試句，並將結果輸出到 test100.txt
"""
...
def run_tests_and_save():
    """執行測試並將結果保存到 test100.txt"""
    print("開始測試 parser_date_time 函數 (100句)...")
    print("=" * 80)

    with open('test100.txt', 'w', encoding='utf-8') as f:
        f.write("parser_date_time 函數測試結果 (100句)\n")
        f.write("=" * 80 + "\n")
